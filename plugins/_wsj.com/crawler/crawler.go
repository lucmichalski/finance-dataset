...
func Extract(cfg *config.Config) error {
	...
	c.OnHTML(`html`, func(e *colly.HTMLElement) {
		...
		e.ForEach(`li.article-breadCrumb a`, func(_ int, el *colly.HTMLElement) {
			if el.Text != "" {
		...
		// title
		page.Title = e.ChildText("h1.wsj-article-headline")

		// author
		var authors []string
		e.ForEach(`button.author-button`, func(_ int, el *colly.HTMLElement) {
			if el.Text != "" {
